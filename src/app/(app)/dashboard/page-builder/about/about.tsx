...
const defaultAbout: AboutFormData = {
  title: "About Us",
  content: "Enter your about us content here...",
};
...
export function AboutBuilder({
  ...
  saveAbout?: (data: AboutFormData) => Promise<{ success: boolean }>;
}) {
  const [loading, setLoading] = useState(false);

  const form = useForm<AboutFormData>({
    resolver: zodResolver(aboutSchema),
    defaultValues: data || defaultAbout,
  });
